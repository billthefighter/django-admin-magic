...
class ForeignKeyModel(models.Model):
    ...
    # Basic foreign key
    simple_foreign_key = models.ForeignKey(
        SimpleModel, 
    ...
    complex_foreign_key = models.ForeignKey(
        ComplexModel,
        on_delete=models.CASCADE,
        related_name='fk_models'
    )
...
class GenericForeignKeyModel(models.Model):
    ...
    content_type_nullable = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='gfk_models_nullable'
    )
    object_id_nullable = models.PositiveIntegerField(null=True, blank=True)
    content_object_nullable = GenericForeignKey(
