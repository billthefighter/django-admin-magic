...
class TestDatabaseSpecificFeatures:
    ...
    def test_json_field_handling(self):
        ...
        complex_model = ComplexModel.objects.create(
            char_field="Test JSON",
            json_field={"key": "value", "list": [1, 2, 3], "nested": {"a": "b"}}
        )
    ...
    def test_binary_field_handling(self):
        ...
        complex_model = ComplexModel.objects.create(
            char_field="Test Binary",
            binary_field=b'binary_data_test'
        )
...
class TestDatabaseTransactions:
    ...
    def test_transaction_rollback_handling(self):
        ...
        with transaction.atomic():
            # Create an instance
            simple = SimpleModel.objects.create(name="Transaction Test", is_active=True)
    ...
    def test_nested_transaction_handling(self):
        ...
        with transaction.atomic():
            # Inner transaction
            with transaction.atomic():
                simple = SimpleModel.objects.create(name="Nested Test", is_active=True)
...
class TestDatabaseBackendSpecific:
    ...
    def test_mysql_specific_features(self):
        ...
        if connection.vendor == 'mysql':
            ...
            with transaction.atomic():
                simple = SimpleModel.objects.create(name="MySQL Test", is_active=True)
    ...
    def test_sqlite_specific_features(self):
        ...
        if connection.vendor == 'sqlite':
            ...
            with transaction.atomic():
                simple = SimpleModel.objects.create(name="SQLite Test", is_active=True)
    ...
    def test_oracle_specific_features(self):
        ...
        if connection.vendor == 'oracle':
            ...
            with transaction.atomic():
                simple = SimpleModel.objects.create(name="Oracle Test", is_active=True)
