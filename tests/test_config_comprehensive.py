...
class TestAppSettings:
    ...
    def test_getattr_with_default_setting(self):
        ...
        assert app_settings.DEFAULT_DO_NOT_REGISTER_FILTER_STRING_LIST == defaults.DEFAULT_DO_NOT_REGISTER_FILTER_STRING_LIST
...
class TestDefaults:
    ...
    def test_defaults_are_immutable(self):
        ...
        original_excluded_terms = defaults.DEFAULT_EXCLUDED_TERMS.copy()
        original_filter_list = defaults.DEFAULT_DO_NOT_REGISTER_FILTER_STRING_LIST.copy()
        original_attributes = defaults.ADMIN_TUPLE_ATTRIBUTES_TO_LIST.copy()
