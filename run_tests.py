...
Examples:
  ...
  python run_tests.py --database postgresql  # Run tests with PostgreSQL
    ...
    parser.add_argument(
        "-vv", "--very-verbose",
        action="store_true",
        help="Run tests with very verbose output"
    )
    parser.add_argument(
        "--coverage",
        action="store_true",
    ...
    parser.add_argument(
        "--reuse-db",
        action="store_true",
        help="Reuse test database for faster runs"
    )
    ...
    parser.add_argument(
        "--database-tests",
        action="store_true",
        help="Run database-agnostic tests against all available databases"
    )
